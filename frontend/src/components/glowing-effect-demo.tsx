    ...
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-xl border p-2 md:rounded-2xl md:p-3">
        <GlowingEffect
          ...
          inactiveZone={0.01}
        />
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-lg p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
