...
graph TD
    ...
    C -->|Router.launchToken (pay launch fee)| RL[SovryRouter.launchToken]
    RL --> FL[SovryFactory.launchToken]
    FL -->|Forward launch fee ETH| TREAS[Treasury]
...
graph TD
    ...
    XB --> STATE[Update bonding curve supply & reserveBalance]
...
graph TD
    ...
    XS --> STATE[Update bonding curve supply & reserveBalance]
